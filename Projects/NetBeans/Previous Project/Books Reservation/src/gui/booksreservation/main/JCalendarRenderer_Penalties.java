...
class JCalendarRenderer_Penalties implements TableCellRenderer {
     ...
     public JCalendarRenderer_Penalties(final JPanel panel) {
     ...
     public JCalendarRenderer_Penalties(final JLabel label) {
     ...
     public JCalendarRenderer_Penalties(final JTextArea textArea) {
