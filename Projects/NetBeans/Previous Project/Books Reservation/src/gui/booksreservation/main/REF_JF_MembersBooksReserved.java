...
public class REF_JF_MembersBooksReserved extends javax.swing.JFrame {
     ...
     public REF_JF_MembersBooksReserved() {
          initComponents();
          /**/
          jTableMembers_TableModel = (DefaultTableModel) jTableMembersBooksReserved.getModel();
          jTable_setShowHorizontalLines(jTableMembersBooksReserved);
          jTable_setTableHeader(jTableMembersBooksReserved);
          /**/
...
// ------------------------------------------------------------------------ []
     ...
     public void initialize_results_fill_jTableMembers() {
          try {
               ...
               if (conn != null) {
                    ...
                    max_results_query = ref_reserve.administrator_count_information_by_idmembers_reserve_history_and_not_expired_and_status_is_reserved(this.getIdmembers(), conn);
     ...
     public void fill_jTableMembers(int idmembers, int limit_first, int limit_second, Connection conn) {
          try {
               jTableMembers_TableModel.setRowCount(0);

               /**/
               int CountListResults;
               CountListResults = ref_reserve.administrator_select_information_by_idmembers_reserve_history_and_not_expired_and_status_is_reserved(idmembers, limit_first, limit_second, conn);
               for (int i = 0; i < reserve.getData().size(); i++) {
                    jTableMembers_TableModel.addRow((Vector) reserve.getData().get(i));
                    if (jTableMembersBooksReserved.getRowCount() == 1) {
                         limit_first += 1;
                         ...
                         int get_rowCount = jTableMembersBooksReserved.getRowCount();
    ...
    private void jTable_setTableHeader(JTable jTable) {
     ...
     public void getSelectedRowCount_jTableMembers() {
          int getSelectedRowCount = jTableMembersBooksReserved.getSelectedRowCount();
...
//          return new JCalendarRenderer(new JTextArea());
    ...
    private void initComponents() {
        ...
        jScrollPaneMembersBooksReserved = new javax.swing.JScrollPane();
        jTableMembersBooksReserved = new javax.swing.JTable();
        ...
        jScrollPaneMembersBooksReserved.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jScrollPaneMembersBooksReservedMouseClicked(evt);
            }
        });

        jTableMembersBooksReserved.setAutoCreateRowSorter(true);
        jTableMembersBooksReserved.setBackground(new java.awt.Color(153, 0, 0));
        jTableMembersBooksReserved.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jTableMembersBooksReserved.setForeground(new java.awt.Color(255, 255, 255));
        jTableMembersBooksReserved.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "idreserve", "ID Number", "Name", "Barcode", "Title", "Notes", "Reserved Date", "Reserved Until", "Copies", "Is Expired"
            }
        ) {
        ...
        jTableMembersBooksReserved.setRowHeight(24);
        jTableMembersBooksReserved.setSelectionBackground(new java.awt.Color(0, 0, 0));
        jTableMembersBooksReserved.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableMembersBooksReservedMouseClicked(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                jTableMembersBooksReservedMouseReleased(evt);
            }
        });
        jTableMembersBooksReserved.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTableMembersBooksReservedKeyReleased(evt);
            }
        });
        jScrollPaneMembersBooksReserved.setViewportView(jTableMembersBooksReserved);
        jTableMembersBooksReserved.getColumnModel().getColumn(0).setMinWidth(0);
        jTableMembersBooksReserved.getColumnModel().getColumn(0).setMaxWidth(0);
        jTableMembersBooksReserved.getColumnModel().getColumn(1).setMinWidth(0);
        jTableMembersBooksReserved.getColumnModel().getColumn(1).setPreferredWidth(0);
        jTableMembersBooksReserved.getColumnModel().getColumn(1).setMaxWidth(0);
        jTableMembersBooksReserved.getColumnModel().getColumn(1).setCellRenderer(createMembersIDNumberColumnRenderer());
        jTableMembersBooksReserved.getColumnModel().getColumn(2).setMinWidth(0);
        jTableMembersBooksReserved.getColumnModel().getColumn(2).setPreferredWidth(0);
        jTableMembersBooksReserved.getColumnModel().getColumn(2).setMaxWidth(0);
        jTableMembersBooksReserved.getColumnModel().getColumn(3).setMinWidth(0);
        jTableMembersBooksReserved.getColumnModel().getColumn(3).setPreferredWidth(90);
        jTableMembersBooksReserved.getColumnModel().getColumn(3).setMaxWidth(200);
        jTableMembersBooksReserved.getColumnModel().getColumn(6).setMinWidth(120);
        jTableMembersBooksReserved.getColumnModel().getColumn(6).setPreferredWidth(120);
        jTableMembersBooksReserved.getColumnModel().getColumn(6).setMaxWidth(120);
        jTableMembersBooksReserved.getColumnModel().getColumn(6).setCellRenderer(createJCalendarColumnRenderer());
        jTableMembersBooksReserved.getColumnModel().getColumn(7).setMinWidth(120);
        jTableMembersBooksReserved.getColumnModel().getColumn(7).setPreferredWidth(120);
        jTableMembersBooksReserved.getColumnModel().getColumn(7).setMaxWidth(120);
        jTableMembersBooksReserved.getColumnModel().getColumn(7).setCellRenderer(createJCalendarColumnRenderer());
        jTableMembersBooksReserved.getColumnModel().getColumn(8).setMinWidth(60);
        jTableMembersBooksReserved.getColumnModel().getColumn(8).setMaxWidth(60);
        jTableMembersBooksReserved.getColumnModel().getColumn(9).setMinWidth(0);
        jTableMembersBooksReserved.getColumnModel().getColumn(9).setPreferredWidth(0);
        jTableMembersBooksReserved.getColumnModel().getColumn(9).setMaxWidth(0);

        jPanel8.add(jScrollPaneMembersBooksReserved);
     ...
     private void jTableMembersBooksReservedMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMembersBooksReservedMouseClicked
     ...
     }//GEN-LAST:event_jTableMembersBooksReservedMouseClicked

     private void jTableMembersBooksReservedMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMembersBooksReservedMouseReleased
          int buttonChoice = evt.getButton();
          switch (buttonChoice) {
               case 1: // IF MOUSE IS LEFT CLICKED
                    getSelectedRowCount_jTableMembers();
     ...
     }//GEN-LAST:event_jTableMembersBooksReservedMouseReleased

     private void jTableMembersBooksReservedKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTableMembersBooksReservedKeyReleased
     ...
     }//GEN-LAST:event_jTableMembersBooksReservedKeyReleased

     private void jScrollPaneMembersBooksReservedMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jScrollPaneMembersBooksReservedMouseClicked
          int buttonChoice = evt.getButton();
          switch (buttonChoice) {
               case 1: // IF MOUSE IS LEFT CLICKED
                    break;
     ...
     }//GEN-LAST:event_jScrollPaneMembersBooksReservedMouseClicked
     ...
     public static void main(String args[]) {
          try {
               ...
               java.util.logging.Logger.getLogger(REF_JF_MembersBooksReserved.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
          }

          java.awt.EventQueue.invokeLater(new Runnable() {
               @Override
               public void run() {
//                    new REF_JF_BooksReservedStudents().setVisible(true);
                    REF_JF_MembersBooksReserved ref_REF_JF_BooksReservedStudents = new REF_JF_MembersBooksReserved();
                    ref_REF_JF_BooksReservedStudents.setSize(950, 600);
                    ref_REF_JF_BooksReservedStudents.setLocationRelativeTo(null);
                    ref_REF_JF_BooksReservedStudents.setVisible(true);
               }
          });
     }
    ...
    public javax.swing.JScrollPane jScrollPaneMembersBooksReserved;
    private javax.swing.JSpinner jSpinner_limitresults;
    public javax.swing.JTable jTableMembersBooksReserved;
